...
export default function Auth({onLogin}: {onLogin: (username: string) => void}) {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    const users = JSON.parse(localStorage.getItem('pajar_users') || '[]');
    ...
    if (isLogin) {
      ...
      localStorage.setItem('pajar_users', JSON.stringify(users));
      onLogin(username);
    }
  };
    ...
    <div className="min-h-screen flex flex-col lg:flex-row bg-sacred-blue overflow-hidden">
      ...
      <div className="w-full lg:w-1/2 relative h-[40vh] lg:h-screen overflow-hidden border-b lg:border-b-0 lg:border-r border-white/5 bg-black">
        ...
        <div className="absolute bottom-12 left-12 right-12 z-10 hidden lg:block">
          ...
          >
            KECERDASAN <br/>
            <span className="text-gold">PajarAI</span>
          </h1>
        ...
        <AnimatePresence mode="wait">
          ...
          >
            <div className="mb-10 lg:hidden text-center">
              <span className="text-sm font-black text-gold tracking-[0.3em] uppercase">Pajar Intelligence</span>
            </div>
            ...
            <div className="mb-10">
              ...
              <p className="text-sacred-white/40 font-medium leading-relaxed">
                {isLogin ? 'Silakan autentikasi identitas Anda untuk masuk ke dalam ekosistem kecerdasan Pajar AI.' : 'Bangun jangkar aman Anda di dalam jaringan saraf PajarAI untuk mulai berevolusi.'}
              </p>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="relative group overflow-hidden rounded-2xl">
                ...
                >
                  {isLogin ? 'MASUK KE PAJAR' : 'INISIASI AKUN'}
